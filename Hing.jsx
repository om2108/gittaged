...
const Products = [
    {
        id: 1,
        title: 'GiTAGGED® Hathras Hing (Compounded) – 100gms',
        name: 'Hinge',
        category: 'Spices',
        price: 192,
        rating: 4.00,
        image: 'https://www.gitagged.com/wp-content/uploads/2023/06/Hathras-Hing-1.jpg',
        thumbnails: [
                    ...
                    <Col xs={12} md={5} className="py-3">
                        ...
                        <Accordion defaultActiveKey={['0']} alwaysOpen>
                            <Accordion.Item eventKey="0">
                                <Accordion.Header>Uniqueness</Accordion.Header>
                                <Accordion.Body>
                                    <ul>
                                        {Uniqueness.map(item => (
